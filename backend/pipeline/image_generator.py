...
OUTPUTS_DIR = BASE_DIR / "backend" / "outputs" / "images"
...
def _request_json(url, payload=None, retries=3):
  data = None
...
def generate_image(analysis):
  ...
  ts = int(time.time())
  out_file = OUTPUTS_DIR / f"thumb_{ts}.png"
  raw_file = OUTPUTS_DIR / f"raw_{ts}.png"
